...
export function generatePagination(totalCnt, limit, currentPage, category_level_one, category_level_two) {
...
//                     const contentDiv = document.getElementById('healthCareContent');
//                     contentDiv.innerHTML = data;
//                     theme = "healthCareArticles"
//                     level_one = category_level_one
//                     level_two = category_level_two
...
//     loadContent('home', homeLink, 20, 1, '', '', false);
// });